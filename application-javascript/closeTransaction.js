...
async function closeTransaction(ccp,wallet,user,transactionID) {
    try {
      ...
      await gateway.connect(ccp,
        ...
        //console.log('\n--> Evaluate Transaction: query the transaction you want to close');
        ...
        let statefulTxn = contract.createTransaction('CloseTransaction');
...
async function main() {
    try {
        ...
        if (process.argv[2] == undefined || process.argv[3] == undefined
            ...
            console.log("Usage: node closeTransaction.js org userID transactionID");
            process.exit(1);
        }
        ...
        if (org == 'Org1' || org == 'org1') {
            ...
            await closeTransaction(ccp,wallet,user,transactionID);
        }
